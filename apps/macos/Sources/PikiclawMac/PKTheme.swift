...
enum PKTheme {
    static let surface = pkAdaptive(light: pkColor(0.969, 0.973, 0.980), dark: pkColor(0.067, 0.067, 0.075))
    static let surfaceRaised = pkAdaptive(light: pkColor(1, 1, 1), dark: pkColor(0.106, 0.110, 0.122))
    static let surfaceHover = pkAdaptive(light: pkColor(0.925, 0.941, 0.961), dark: pkColor(0.176, 0.180, 0.200))
    static let sidebar = pkAdaptive(light: pkColor(1, 1, 1, 0.92), dark: pkColor(0.078, 0.082, 0.094, 0.88))
    static let panel = pkAdaptive(light: pkColor(1, 1, 1), dark: pkColor(0.106, 0.110, 0.122))
    static let panelAlt = pkAdaptive(light: pkColor(0.973, 0.980, 0.988), dark: pkColor(0.176, 0.180, 0.200))
    static let control = pkAdaptive(light: pkColor(0.059, 0.090, 0.165, 0.050), dark: pkColor(1, 1, 1, 0.060))
    static let controlBorder = pkAdaptive(light: pkColor(0.059, 0.090, 0.165, 0.180), dark: pkColor(0.58, 0.64, 0.72, 0.28))
    static let selected = pkAdaptive(light: pkColor(0.059, 0.090, 0.165, 0.060), dark: pkColor(1, 1, 1, 0.070))
    static let inset = pkAdaptive(light: pkColor(0.059, 0.090, 0.165, 0.035), dark: pkColor(1, 1, 1, 0.055))
    static let edge = pkAdaptive(light: pkColor(0.059, 0.090, 0.165, 0.105), dark: pkColor(1, 1, 1, 0.13))
    static let edgeStrong = pkAdaptive(light: pkColor(0.059, 0.090, 0.165, 0.200), dark: pkColor(1, 1, 1, 0.24))
    ...
    static let gridLine = pkAdaptive(light: pkColor(0.059, 0.090, 0.165, 0.045), dark: pkColor(1, 1, 1, 0.035))
}
