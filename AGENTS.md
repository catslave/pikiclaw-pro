...
Pikiclaw is Trellis-managed. Treat `AGENTS.md`, `.trellis/workflow.md`, `.trellis/tasks/**`, and `.trellis/spec/**` as the shared project-management contract for non-trivial work.
