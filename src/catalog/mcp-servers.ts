...
export const MCP_SERVERS: RecommendedMcpServer[] = [
  ...
  },
  {
    id: 'computer-use',
    name: 'Computer Use',
    description: 'Native macOS computer control powered by Peekaboo MCP (read windows, click, type, scroll, use menus and apps). Requires Screen Recording + Accessibility permissions. macOS only.',
    descriptionZh: '基于 Peekaboo MCP 的原生 macOS Computer Use 能力（读取窗口、点击、输入、滚动、操作菜单和应用）。需要"屏幕录制"与"辅助功能"两项系统权限，仅支持 macOS。',
    category: 'utility',
    recommendedScope: 'global',
    ...
    auth: {
      ...
      fields: [
        ...
        },
        {
          ...
          secret: true,
          required: true,
          placeholder: 'Atlassian API token or MCP bearer token',
        },
      ],
    },
    iconSlug: 'atlassian',
      ...
      fields: [
        {
          ...
          labelZh: 'MCP 地址',
          required: true,
          placeholder: 'https://gitlab.com/api/v4/mcp',
        },
        {
          key: 'MCP_TOKEN',
          label: 'Token',
          ...
          secret: true,
          required: true,
          placeholder: 'GitLab personal access token or MCP bearer token',
        },
      ],
    },
    iconSlug: 'gitlab',
